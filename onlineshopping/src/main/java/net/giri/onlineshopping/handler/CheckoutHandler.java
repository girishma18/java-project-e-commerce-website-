package net.giri.onlineshopping.handler;
...
import net.giri.onlineshopping.model.CheckoutModel;
import net.giri.onlineshopping.model.UserModel;
import net.giri.shoppingbackend.dao.CartLineDAO;
import net.giri.shoppingbackend.dao.ProductDAO;
import net.giri.shoppingbackend.dao.UserDAO;
import net.giri.shoppingbackend.dto.Address;
import net.giri.shoppingbackend.dto.Cart;
import net.giri.shoppingbackend.dto.CartLine;
import net.giri.shoppingbackend.dto.OrderDetail;
import net.giri.shoppingbackend.dto.OrderItem;
import net.giri.shoppingbackend.dto.Product;
import net.giri.shoppingbackend.dto.User;
